...
type TicketUsecase interface{
	Insert(c context.Context, payload TicketPayload) (ticket NewTicket, err error)
	GetTicket(c context.Context, id string) (ticket Ticket, err error)
...
func (uc *ticketUsecase) Insert(c context.Context, payload TicketPayload) (ticket NewTicket, err error){
	ticket, err = uc.ticketRepository.Save(c, payload)

	return ticket, err
}

func (uc *ticketUsecase) GetTicket(c context.Context, id string) (ticket Ticket, err error){
	ticket, err = uc.ticketRepository.GetTicketById(c, id)
